namespace RecyclingStation.WasteDisposal
{
    ...
    public class GarbageProcessor : IGarbageProcessor
    {
        ...
        public IProcessingData ProcessWaste(IWaste garbage)
        {
            ...
            Type typeAttribute = type.GetCustomAttributes(false).First().GetType();
            ...
            if (disposalAttribute == null || !this.StrategyHolder.GetDisposalStrategies.TryGetValue(typeAttribute, out currentStrategy))
            {
