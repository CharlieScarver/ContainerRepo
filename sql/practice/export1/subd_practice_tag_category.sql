...
CREATE TABLE `tag_category` (
  ...
  `categoty_many_tag_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `tag_id_idx` (`tag_id`),
  KEY `category_id_idx` (`categoty_many_tag_id`),
  CONSTRAINT `categoty_many_tag_id` FOREIGN KEY (`categoty_many_tag_id`) REFERENCES `category` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2015-04-17  2:53:43
